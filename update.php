...
<html lang="en">
    <head>                                                                   <!--creamos nuestro head-->
        ...
        <link rel="stylesheet" type="text/css" href="style.css?ts=<?=time()?>" />   <!--Asignamos nuestro CSS, para el diseño-->
        <title>Editar Cliente</title>
        
    </head>
    <body>
        <div class="users-form">                                                                
            <form action="edit.php" method="POST">                                              <!--creamos nuestro formulario para editar los datos de los clientes creados-->
